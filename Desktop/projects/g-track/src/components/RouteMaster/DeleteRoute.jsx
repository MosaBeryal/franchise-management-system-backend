...
// api
import { useDeleteRouteMasterMutation } from "../../Apis/RouteMasterApis/RouteMasterApis";
...
export default function DeleteUser({ open, onClose, seletecRowId }) {
  ...
  const [deleteRoute, { isLoading, error, isSuccess, isError }] =
    useDeleteRouteMasterMutation();

  const handleDelte = async () => {
    await deleteRoute(seletecRowId);
    onClose();
  };
